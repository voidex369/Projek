...
import { ArrowLeft, FileText, Download, FileDown, FileCheck } from 'lucide-react'
...
export default function PDFToWordPage() {
  ...
  const handleProcess = async () => {
    ...
    try {
      ...
      formData.append('preserve_formatting', options.preserveFormatting ? 'true' : 'false')
      formData.append('include_images', options.includeImages ? 'true' : 'false')
      ...
      const response = await fetch('/api/tools/convert/pdf-to-word', {
        method: 'POST',
        body: formData
      })
      ...
      <main className="flex-1 py-12 px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto w-full">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Convert your PDF files to editable Word documents. High accuracy OCR included for scanned PDFs.
          </p>
        </div>
                  ...
                  <>
                        ...
                        <div className="space-y-4">
                          <label className="flex items-start space-x-3">
                            ...
                            <div className="flex-1">
                              ...
                              <p className="text-sm text-gray-500 mt-1">
                                Keep fonts, margins, and paragraph styles as close as possible to original
                              </p>
                            </div>
                          </label>
                          ...
                          <label className="flex items-start space-x-3">
                            ...
                            <div className="flex-1">
                              ...
                              <p className="text-sm text-gray-500 mt-1">
                                Extract and embed images, charts, and tables in the Word document
                              </p>
                            </div>
                          </label>
                        </div>
                    ...
                    <div className="mt-8 flex justify-center">
                      ...
                      >
                        {isProcessing ? (
                          <>
                            <FileCheck className="w-5 h-5 mr-2 animate-bounce" />
                            Converting...
                          </>
                        ) : (
                          <>
              ...
              <CardContent className="pt-6">
                ...
                <ol className="space-y-3 text-sm text-gray-600">
                  ...
                  <li className="flex items-start">
                    ...
                    <span>Choose formatting options</span>
                  </li>
                  <li className="flex items-start">
                    ...
                    <span>Click &quot;Convert to Word&quot;</span>
                  </li>
                  <li className="flex items-start">
